...
from .prediction_algorithms import FactorizedNeighborhood
from .prediction_algorithms import WeightedNeighborhood
...
__all__ = ['AlgoBase', 'NormalPredictor', 'BaselineOnly', 'KNNBasic',
           'KNNWithMeans', 'KNNBaseline', 'SVD', 'SVDpp', 'FactorizedNeighborhood', 'WeightedNeighborhood', 'NMF', 'SlopeOne',
